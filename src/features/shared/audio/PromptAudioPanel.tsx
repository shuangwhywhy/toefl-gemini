    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="inline-flex items-center gap-3 rounded-full border border-slate-200 bg-white px-4 py-2 text-xs font-semibold text-slate-600 shadow-sm">
          <span className="inline-flex items-center gap-1.5" title="Prompt voice">
      ...
      <div className="min-h-[88px] rounded-lg bg-slate-50 p-4">
        {showText ? (
      ...
      <div className="flex flex-wrap items-center gap-2">
        {player.isPlaying ? (
          ...
          >
            ...
            {isLoading ? 'Loading audio...' : player.isPaused ? 'Resume' : 'Play prompt'}
          </button>
        )}
